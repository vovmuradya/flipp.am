<?php if (! $__env->hasRenderedOnce('fb003ca0-a2ce-4348-b5b4-f9f7746e3eb7')): $__env->markAsRenderedOnce('fb003ca0-a2ce-4348-b5b4-f9f7746e3eb7'); ?>
    <?php $__env->startPush('scripts'); ?>
        <script>
            (() => {
                ...
                const localeStrings = {
                    expired: <?php echo json_encode(__('Лот завершён'), 15, 512) ?>,
                    prefix: <?php echo json_encode(__('Осталось'), 15, 512) ?>,
                    dayLabel: <?php echo json_encode(__('д'), 15, 512) ?>,
                };
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /home/admin/web/idrom.am/public_html/resources/views/components/auction/countdown-script.blade.php ENDPATH**/ ?>