<?php if (! $__env->hasRenderedOnce('604ceca9-e693-410c-a5c1-8020a20509ff')): $__env->markAsRenderedOnce('604ceca9-e693-410c-a5c1-8020a20509ff'); ?>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                async function fetchBrands() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(url('/api/brands')); ?>');
                        if (!response.ok) {
                            return [];
                        }
                ...
                async function fetchModels(brandId) {
                    ...
                    try {
                        const response = await fetch(`<?php echo e(url('/api/brands')); ?>/${brandId}/models`);
                        if (!response.ok) {
                            return [];
                        }
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/listings/partials/brand-model-autocomplete-script.blade.php ENDPATH**/ ?>